...
export const projects: Project[] = [
  {
    ...
    description:
      "A full-featured online store built with Next.js, Stripe, and Tailwind CSS. Includes shopping cart, user authentication, and order management.",
  ...
  },
  {
    ...
    description:
      "Collaborative task manager with real-time updates, drag-and-drop interface, and team workspaces.",
  ...
  },
  {
    ...
    description:
      "Real-time weather application using OpenWeatherMap API with location detection and 5-day forecast.",
  ...
  },
  {
    ...
    description:
      "Personal portfolio website with dark mode, animations, and contact form integration.",
